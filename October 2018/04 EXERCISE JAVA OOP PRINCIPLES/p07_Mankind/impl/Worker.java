...
public class Worker extends Human {
    ...
    private static final String INVALID_WORKING_HOURS_PER_DAY_EXCEPTION_MESSAGE = "Expected value mismatch!Argument: workHoursPerDay";
    ...
    private void setWorkHoursPerDay(double workHoursPerDay){
        if (workHoursPerDay > 12){
            throw new IllegalArgumentException(INVALID_WORKING_HOURS_PER_DAY_EXCEPTION_MESSAGE);
        }
